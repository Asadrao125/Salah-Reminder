...
public class SetTargetPicker extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        final int currentVal = ((TasbeehActivity) getActivity()).targetZikr;
        ...
        builder.setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ((TasbeehActivity) getActivity()).showSnackBar(((TasbeehActivity) getActivity()).parentLayout, "Nothing changed");
            }
        });
